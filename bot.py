...
class spotify:
    ...
    def register_account(self):
        ...
        data = f"birth_day=1&birth_month=01&birth_year=1970&collect_personal_info=undefined&creation_flow=&creation_point=https://www.spotify.com/uk/&displayname={follower}&email={email}&gender=neutral&iagree=1&key=a1e486e2729f46d6bb368d6b2bcda326&password={password}&password_repeat={password}&platform=www&referrer=&send-email=1&thirdpartyemail=0&fb=0"
        try:
            ...
            if "login_token" in create.text:
                ...
                with open("Created.txt", "a") as f:
                    ...
                    print(f"\033[96m> \033[92mAccount \033[96m| \033[92m{email}\033[96m:\033[92m{password} \033[96m| \033[92mtoken \033[96m| \033[92m{login_token}")
                return login_token
            else:
                return None
        except:
    ...
    def follow(self):
        ...
        if login_token == None:
            return None, "\033[96m| \033[91mratelimit"
        elif login_token == False:
            if self.proxy == None:
                return None, f"| \033[91munable to send request on register "
            return None, f"\033[96m| \033[91mbad proxy \033[96m| \033[91m{self.proxy}"
        auth_token = self.get_token(login_token)
        if auth_token == None:
            return None, "\033[91mwhile getting auth token"
        headers = {
            "accept": "application/json",
            "Accept-Encoding": "gzip, deflate, br",
            "accept-language": "en",
            ...
            "app-platform": "WebPlayer",
            "Referer": "https://open.spotify.com/",
            "spotify-app-version": "8.6.96.422",
        ...
        try:
            ...
            return False, "\033[91mwhile following \033[96m|"
